...
/**
 * {@code @FileName} com.btrc.datacenter.common.datasource.trait.impl.ds.KingBaseDaaSource
 * {@code @Author} lenovo/No PR
 * {@code @Create} 2024/8/30 16:24
 * {@code @Description} kingbase
 */
public class KingBaseDataSource extends SimpleJDBCUrlSliceSynthesizeDataSource {
    ...
    public KingBaseDataSource(Config connConfig) {
        super(connConfig);
    }
    ...
    protected void throwOnConnConfigIllegal(Config config) throws IllegalConnectionConfigException {
        config.get(ConnConfOptions.SCHEMA)
                ...
                .orElseThrow(() -> new IllegalConnectionConfigException("kingbase not found schema"));
    }
